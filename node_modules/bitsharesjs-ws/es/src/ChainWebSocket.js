...
var ChainWebSocket = function () {
    ...
    ChainWebSocket.prototype.call = function call(params) {
        ...
        if (method === "set_subscribe_callback" || method === "subscribe_to_market" || method === "broadcast_transaction_with_callback"
          || method === "set_pending_transaction_callback" || method ==="set_block_applied_callback") {            // Store callback in subs map
            this.subs[this.cbId] = {
                callback: params[2][0]
            };
